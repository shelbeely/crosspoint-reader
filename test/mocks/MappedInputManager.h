...
class MappedInputManager {
 public:
  ...
  ButtonLabels mapLabels(const char* a, const char* b, const char* c, const char* d) { return {a, b, c, d}; }

  // Test helpers
  void simulatePress(Button b) {
    lastPressed = b;
    pressedFlag = true;
    releasedFlag = false;
  }
  void simulateRelease(Button b) {
    lastPressed = b;
    releasedFlag = true;
    pressedFlag = false;
  }
